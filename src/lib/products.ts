...
const products: Product[] = [
  ...
  },
  {
    ...
    images: ['https://cdn.thewirecutter.com/wp-content/media/2023/09/noise-cancelling-headphone-2048px-0880.jpg?auto=webp&quality=75&width=1024', 'https://placehold.co/600x600.png'],
    rating: 4.9,
  ...
  },
  {
    ...
    images: ['https://images.meesho.com/images/products/417828343/7ayyy_512.webp', 'https://placehold.co/600x600.png'],
    rating: 4.6,
  ...
  },
  {
    ...
    images: ['https://jivisa.in/cdn/shop/files/JiViSa-Premium-Loose-Leaf-Tea-Gift-Box-JiViSa-828.jpg?v=1684807135', 'https://placehold.co/600x600.png'],
    rating: 4.7,
    category: 'Home Goods',
    featured: true,
    stock: 100,
